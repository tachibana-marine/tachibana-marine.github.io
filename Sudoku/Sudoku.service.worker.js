...
/** @type {string} */
const CACHE_VERSION = '1739117698|3458608549';
/** @type {string} */
...
/** @type {string[]} */
const CACHED_FILES = ["Sudoku.html","Sudoku.js","Sudoku.offline.html","Sudoku.icon.png","Sudoku.apple-touch-icon.png","Sudoku.worker.js","Sudoku.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Sudoku.wasm","Sudoku.pck"];
